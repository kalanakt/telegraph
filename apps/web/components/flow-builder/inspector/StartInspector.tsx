  ...
  return (
    <>
      <div className="builder-section space-y-2">
        ...
        <div className="flex items-center gap-2 rounded-sm border border-border/80 bg-white/65 px-3 py-2">
          ...
          <button
            ...
            className="nodrag nopan flex items-center gap-1 rounded-sm border border-border/80 bg-secondary/70 px-2 py-1 text-[10px] font-medium text-foreground/75"
          >

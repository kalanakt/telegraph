...
import { createLogger, createWorker, decryptBotToken, QUEUE_NAMES, TokenBucketLimiter, } from '@telegraph/shared';
            ...
            switch (method) {
                case 'sendMessage': {
                    ...
                    if (params['parse_mode'])
                        msgOpts['parse_mode'] = params['parse_mode'];
                    if (params['reply_markup'])
                        msgOpts['reply_markup'] = params['reply_markup'];
                ...
                case 'sendPhoto': {
                    const photoOpts = {};
                    if (params['caption'])
                        photoOpts['caption'] = params['caption'];
                ...
                case 'sendVideo': {
                    const videoOpts = {};
                    if (params['caption'])
                        videoOpts['caption'] = params['caption'];
                ...
                case 'sendDocument': {
                    const docOpts = {};
                    if (params['caption'])
                        docOpts['caption'] = params['caption'];
                ...
                case 'sendAudio': {
                    const audioOpts = {};
                    if (params['caption'])
                        audioOpts['caption'] = params['caption'];
